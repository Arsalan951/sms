...
if(isset($_POST['btn_search']))
{
	...
	$cid = $_POST['s_p_id'];
	$se = mysqli_query($con,"SELECT * FROM  sms_login WHERE login_email='$cid' ");
										...
										<div class="widget-main">
                                            	...
                                            	<fieldset>
													<div class="clearfix">
														...
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="Portal ID" name="s_p_id" />
											...
											<form method="post">
												<fieldset>
                                                    ...
                                                    <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="email" class="form-control" placeholder="Email" value="<?php echo $portalid?>" name="txtemail" readonly/>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="txt" class="form-control" placeholder="Password" value="<?php echo $password?>" name="txtpassword" Required/>
													...
													<label class="block clearfix">
														<div>
															<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="Security Question" value="<?php echo $securityquestion?>" name="txtsecurityquestion" Required/>
                                                    ...
                                                    <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="Security Answer" value="<?php echo $securityanswer?>" name="txtsecurityanswer" Required/>
															<i class="ace-icon fa fa-pencil pink2"></i>
														</span>
													</label>
                                                    <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="Roll" value="<?php echo $roll?>" name="txtlogroll" Required/>
															<i class="ace-icon fa fa-pencil pink2"></i>
														</span>
													</label>
...
$roll=$_POST['txtlogroll'];

$update=mysqli_query($con,"UPDATE sms_login SET login_name='$username',login_pass='$password',login_qus='$securityquestion',login_ans='$securityanswer',login_roll='$roll' where login_email='$portalid'");	
