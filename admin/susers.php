...
{
$id2=$_GET['delete'];
$delete=mysqli_query($con,"DELETE FROM sms_login WHERE 	login_id=$id2");
if($delete>0)
{ 
                              	...
                              	<div class="col-md-8">
                                	<form class="form-horizontal" role="form" method="post">
                                       			...
                                       			<div class="clearfix">
														...
														<button type="submit" class="width-65 pull-right btn btn-sm btn-info" name="show_all">
															<span class="bigger-110">Show All Users</span>
                                        ...
                                        echo"<table id='simple-table' class='table  table-bordered table-hover'>";
											echo"<thead>";
												echo"<tr>";
                                                    ...
                                                    echo"<th>Security Answer</th>";
													echo"<th>Login Roll</th>";
                                                    echo"<th></th>";
												echo"</tr>";
											echo"</thead>";
											$fetch=mysqli_query($con,"select * from sms_login");
											echo"<tbody>";
											echo"<tr>";
											while($row=mysqli_fetch_array($fetch))
												{
                                                    ...
                                                    echo"<td>$row[5]</td>";
                                                    echo"<td>$row[6]</td>";
													echo"<td><a href='susers.php?delete=$row[0]'><i class='ace-icon fa fa-trash-o red bigger-150'></i></a>";
													echo"</td>";
											echo"</tr>";
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">School Mangtaa</span>
