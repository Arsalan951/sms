...
<html lang="en">
	...
	$roll=$_POST['s_roll'];*/
												$fetch=mysqli_query($con,"select * from sms_attendance where att_st_roll = '$srol'");
											$total = mysqli_query($con,"select count(att_st_roll) from sms_attendance where att_st_roll = '$srol'");
