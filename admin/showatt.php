...
function abc(e)
{
  ...
  xhttp.onreadystatechange = function()
  {
    ...
    xhttp.open("GET", "attandance_tble.php?id="+e, true);
  xhttp.send();
}
    ...
    <!------------------------------------------------------------------------------------------------------------------------------------------------------------>
		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
		<meta charset="utf-8" />
		<title>Dashboard - Mangtaa Admin</title>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
                            ...
                            <li class="active">Mark Attandance</li>
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<form method="POST">
																...
																Enter student's roll number: &emsp;&emsp;&emsp;
																<input align="right" type="text" name="s_roll"/>
																</div>
																...
																&emsp;&emsp;&emsp;
																<button type="submit" class="width-25 pull-center btn btn-sm btn-info" name="btn_show">
															<span class="bigger-110">Show</span>

															<i class="ace-icon fa fa-check icon-on-right"></i>
														</button><br/><br/>
											</form>
											<div id="fee">
											<?php if(isset($_POST['btn_show']))
										{
											
											
	$roll=$_POST['s_roll'];
												$fetch=mysqli_query($con,"select * from sms_attendance where att_st_roll = '$roll'");
											$total = mysqli_query($con,"select count(att_st_roll) from sms_attendance where att_st_roll = '$roll'");
