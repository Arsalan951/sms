				...
				<div class="navbar-header pull-left">
					<a href="index.html" class="navbar-brand">
						<small>
							...
							School School Management System Admin
						</small>
					</a>
				</div>
                                            	...
                                            	<fieldset>
													<div class="clearfix">
														...
														<div>
																...
																<input align="right" type="text" name="roll"/>
																</div>
																</br>
																<div border="1px black solid">
																Enter student's class: &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;
																<input  align="right" type="text" name="class"/>
																</div>
                                                        ...
                                                        <div class="form-group">
																		<label class="col-sm-3 control-label no-padding-right">Attandance Date</label>
...
$date = $_POST['txt_dob'];								
	$insert="insert into sms_attendance values('','$s_roll','$date','$class')";
